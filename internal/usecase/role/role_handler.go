...
func NewRoleHandler(
	...
	return &roleHandler{service: roleService, SearchHandler: searchHandler, Params: params, builder: builder}
}
...
func (h *roleHandler) Create(w http.ResponseWriter, r *http.Request) {
	var role Role
	er1 := Decode(w, r, &role, h.builder.BuildToInsert)
	if er1 == nil {
...
func (h *roleHandler) Update(w http.ResponseWriter, r *http.Request) {
	var role Role
	er1 := DecodeAndCheckId(w, r, &role, h.Keys, h.Indexes, h.builder.BuildToUpdate)
	if er1 == nil {
		errors, er2 := h.Validate(r.Context(), &role)
...
func (h *roleHandler) Patch(w http.ResponseWriter, r *http.Request) {
	var role Role
	r, json, er1 := BuildMapAndCheckId(w, r, &role, h.Keys, h.Indexes, h.builder.BuildToPatch)
	if er1 == nil {
		errors, er2 := h.Validate(r.Context(), &role)
